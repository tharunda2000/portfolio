  ...
  return (
    <div className='flex flex-col relative items-center justify-center  top-40  '>
        ...
        <div className='flex gap-3 lg:gap-10'>
          ...
          <input type="button" value="PROJECTS" onClick={()=>{navigate('/projects')}} className='bg-gray-50 mt-5 lg:mt-20 relative p-4 rounded-xl w-40 lg:w-60 text-3xl changa-one-regular font-bold cursor-pointer hover:bg-black hover:text-white shadow-sm shadow-white ' />
          <a
            href="/Tharunda_resume.pdf"
            download="Tharunda_CV.pdf"
            className="bg-gray-50 mt-5 text-center lg:mt-20 relative p-4 rounded-xl w-40 lg:w-60 text-3xl changa-one-regular font-bold cursor-pointer hover:bg-black hover:text-white shadow-sm shadow-white "
          >
            MY CV
          </a>
