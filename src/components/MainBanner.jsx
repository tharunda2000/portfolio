    ...
    <div className='flex flex-col relative items-center justify-center  top-40  '>
        ...
        <div className='flex gap-10'>
          ...
          <a
            ...
            className="bg-gray-50 mt-5 lg:mt-20 relative p-4 rounded-xl w-60 text-3xl changa-one-regular font-bold cursor-pointer hover:bg-black hover:text-white shadow-sm shadow-white "
          >
            DOWNLOAD CV
          </a>
